...
async function boot() {
  const [skills, lessons, questions, errors, exercises, specialTopics, specialTopicStudy, summerG1G2, summerG2G3, summerG3G4, summerG4G5, summerG5G6, summerG6G7, summerG7G8, summerG8G9] = await Promise.all([
    ...
    loadJson("data/special-topic-study.json"),
