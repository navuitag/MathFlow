...
const SCENE_GROUPS = {
  lab: ["set", "place", "estimate", "concept", "logic", "pemdas", "percent", "integerOps"],
  motion: ["numberLine", "arithmetic", "power"],
  geometry: ["geometry", "symmetry", "angle", "triangle", "solid", "circle"],
  fraction: ["fractionCompare", "fractionBar"],
  lever: ["equationBalance", "ratio", "system"],
  optics: ["graph", "parabola", "algebra", "inequality", "radical", "divisibility", "factor"],
  thermal: ["data", "chart", "frequency", "probability"]
};
...
export const SCENE3D_CAPTIONS = {
  geometry: "Hình học không gian 3D",
  solid: "Khối đa diện — quan sát từ mọi góc",
  fractionBar: "Phân số trên thanh 3D",
  numberLine: "Trục số và vị trí",
  graph: "Đồ thị hàm số trong không gian",
  algebra: "Biểu thức đại số minh họa 3D"
};
